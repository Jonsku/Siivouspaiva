...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to www document root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/proto/newsImages/',												
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> '/proto/newsImages/', 				
	...
	$cfg['ilibs_dir'] 	   = array('/proto/newsImages/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	//$cfg['base_url'] 	= 'http://test.test:8888/';
