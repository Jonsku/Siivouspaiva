    ...
    <div class="span12">
      <div class="row">
        ...
        <ul class="partner span4">
          ...
          <li><a href="http://www.lassila-tikanoja.fi" target="_blank"><img src="<?php echo $config['paths']['base_url']; ?>/partners/lt.gif" alt="Lassila tikanoja"></a></li>
          ...
          <li><a href="http://www.uff.fi/" target="_blank"><img src="<?php echo $config['paths']['base_url']; ?>/partners/uff.gif" alt="UFF Auttamisen iloa"></a></li>
        </ul>
        <ul class="partner span4">
